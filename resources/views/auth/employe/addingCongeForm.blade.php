...
<input type="hidden"  name="status" value="Pending" >
  ...
  <div class="mb-6">
    ...
    <input type="text" id="nom" name="nom" value="{{auth()->user()->last_name.' '.auth()->user()->first_name}}" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5"  disabled>
  </div>
  <div class="mb-6">

...
@endif
  <div class="grid grid-cols-2 gap-6">
    <div style="width: 200px; height: 200px; border-radius: 50%; overflow: hidden;">
            <img id="profile-image" src="{{url('Image/'.auth()->user()->image)}}"  alt="Profile Image" style="width: 100%; height: 100%; object-fit: cover;">
          </div>
    <input id="photo" type="file" id="photo" name="photo"  placeholder="photo">
  </div>
...
<div class="grid grid-cols-2 gap-6">
  ...
  <div class="mb-6 ">
    ...
    <div class="grid grid-cols-2 gap-6">
    <div class="mb-6">
        <label for="numdesom" class="block mb-2 text-sm font-medium text-gray-900">Dnuméro de som</label>
    ...
    <div class="flex justify-center">
      <button type="submit" onclick="submitForm(event,'voulez-vous enregistrer ces modification ?','Enregistrer')" class="bg-blue-500 hover:bg-blue-600 text-white font-medium py-2.5 px-5 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2">Modifier</button>
    </div>

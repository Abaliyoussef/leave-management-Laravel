...
<form class="w-full max-w-md mx-auto mt-10" method="post" action="{{route('departements.store')}}">
		
@csrf
<h2 class="text-xl font-bold mb-6">création</h2>
  <div class="mb-6">
    <label for="nom" class="block mb-2 text-sm font-medium text-gray-900">nom</label>
    <input type="text" id="nom" name="nom" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5" placeholder="nom du département">
